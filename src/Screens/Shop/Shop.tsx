...
export const Shop = ({showShop, handleShowShop, acc, handleSetAcc} : shopProps) => {
  ...
  return (
    <div className="section full-height">
      ...
      <label htmlFor="modal-btn" style={{marginBottom:"200px", marginLeft:"300px", width:"80px"}}>Shop</label>

      <div className="modal">
        <div className="modal-wrap" style={{backgroundImage: `url(${background})` }}>
          <img src={catDress} alt="Cat"/>
          <div className="row">
